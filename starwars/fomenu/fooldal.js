...
$("#reg_jelszo_megegyszer").keypress(function (e) {
  if (e.which == 13) {
	 ...
	 $("#registergomb").click(function(){
		 ...
		 $.post("fomenu/felhasznalo_felvitel.php",adatok,function(eredmeny){
			//alert(eredmeny); 
			if (eredmeny==1)
			{
	 ...
	 $("#reg").click(function(){
	  ...
	  $("#logoutgomb").click(function(){
        //alert("megnyomva");
		$.post("fomenu/kilepes.php",function(eredmeny){
			if (eredmeny==1)
				location.reload();
		});
    ...
    $("#logingomb").click(function(){
		...
		$.post("fomenu/belepes.php",adatok,function(eredmeny){
			//alert(eredmeny);
			if (eredmeny==0)
				alert("Hiba");
			else
